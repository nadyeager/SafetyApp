...
class Accident_InvestigationsController extends Controller
{
    ...
    {
        return view('accident_investigations.edit', compact('investigation'));
    }
    ...
    public function update( Request $request, Accident_Investigations $investigation)
    {
        ...
        return redirect()->route('accidents.show', $investigation->accident_id)
            ->with('success', 'Accident Investigation updated successfully.');
    }
