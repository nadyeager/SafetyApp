...
@section('content')
    ...
    <form action="{{ route('manhours.store') }}" method="POST" class="space-y-4">
        @csrf
        <div>
        ...
        <div>
            <x-input-label for="total_hours" :value="__('Total_Hours')"/>
                <x-text-input id="total_hours" class="block mt-1 w-full" type="number" name="total_hours" :value="old('total_hours')" required autofocus autocomplete="off"/>
