...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (chartElement2) {
        ...
        new Chart(chartElement2, { // ⚠ sebelumnya typo: new chartElement → harus Chart
            type: 'doughnut',
            data: {
                labels: labels,
                datasets: [{
    ...
    // ====================================================
    // ⛰ TOTAL MANHOURS (Area Chart - “Gunung”)
    // ====================================================
    ...
    if (chartElement4) {
        ...
        new Chart(chartElement4, { // ⚠ sebelumnya typo: new chart → harus Chart
            type: 'pie',
            data: {
                labels: labels,
                datasets: [{
